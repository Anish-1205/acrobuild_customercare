...
class BackendStartupTests(unittest.TestCase):
    ...
    def test_heavy_startup_work_is_disabled_by_default(self, refresh_index, warm_translation):
    ...
    @patch("api_context.warm_translation_model_async")
    @patch("api_context.refresh_workspace_index_async")
    def test_heavy_model_preload_can_be_enabled_explicitly(self, refresh_index, warm_translation):
